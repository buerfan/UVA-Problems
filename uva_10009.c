...
int main()
{
    int edge,test=0,i,j,k,te,testCase,index1,query,index2,source,destination,c=0;
    char start[100],end[100],sour[100],des[100];
    //freopen("bfs_input_str.txt","r",stdin);
    freopen("uva_10009_r.txt","r",stdin);
    //freopen("uva_10009_w.txt","w",stdout);
    scanf("%d",&testCase);
